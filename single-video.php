...
class SWPTemplateSample {
	...
	public function swp_video_entry_function() {
		...
		*/
		...
		$post_type 			= 'video';
		$template 			= 'mediaobject_entry_video.php'; // will default to pre-coded sample_template.php if no value is declared
		$tax_name 			= '';
		$tax_term			= '';
		...
		echo '<div class="group entry-video">';
	...
	public function __construct() {
		...
		if( !is_admin() ) {
			...
			add_action( 'genesis_loop', array( $this, 'swp_video_entry_function' ) );
			add_action( 'genesis_loop', array( $this, 'swp_video_related_function' ) );
