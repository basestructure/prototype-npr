...
class SWPTemplateSample {
	...
	public function swp_podcast_entry_function() {
		...
		*/
		...
		echo '<div class="group entry-podcast">';
	...
	public function __construct() {
		...
		if( !is_admin() ) {
			...
			add_action( 'genesis_loop', array( $this, 'swp_podcast_entry_function' ) );
			add_action( 'genesis_loop', array( $this, 'swp_podcast_related_function' ) );
