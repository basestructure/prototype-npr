...
//		$paged 				= ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1;
		...
		$more = array(
						'tag-open'		=> '<div id="feature-article" class="space-bottom">', // opening container tag here
	...
	private $MyAds = array(
				'cell' => array(
					array(
						'cell_target'	=> 3, // any number or random | rand( 1, $show_entries );
						'cell_content'	=> '<div class="module-mediaobject module-sublevel module-vertical" style="background-color:gray;"><h3>Ad Space</h3></div>',
						'cell_page'		=> 1, // in what set (page) do you want to the ad to show. leave empty/blank/0 to show in every set
						'cell_repeat'	=> FALSE, // if TRUE, the ad will show in every set of $show_entries
					),
					/*array(
						'cell_target'	=> 5, // any number or random | rand( 1, $show_entries );
						'cell_content'	=> '<div class="module-mediaobject module-sublevel module-vertical" style="background-color:orange;"><h3>Ad Space</h3></div>',
						'cell_page'		=> 2, // in what set (page) do you want to the ad to show. leave empty/blank/0 to show in every set
						'cell_repeat'	=> FALSE, // if TRUE, the ad will show in every set of $show_entries
					),*/
				),
	);
	...
	public function swp_load_scripts_func() {
		...
		// Register the script
		wp_register_script( 'flexi_temp_ajax', get_stylesheet_directory_uri() . '/swp_template/js/asset_archive_template.js', array( 'jquery' ), NULL, TRUE );
